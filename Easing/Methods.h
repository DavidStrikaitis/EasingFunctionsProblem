...
float moveHorizLine(float t) { 
    return 0.5f; // <= Modify this line
}

float changeSlope(float t) { 
    return t/2; // <= Modify this line
}

float changeSlopeAndMove(float t) { 
    return t/4 + 0.25 ; // <= Modify this line
}

float makeParabolic(float t) {
    return t * t;// <= Modify this line
}
...
float moveParabolaUp(float t) { 
    return sqr(t - 0.5) + 0.5;  // <= Modify this line
}

float invertParabola(float t) { 
    return -sqr(t - 0.5) + 1; // <= Modify this line
}

float narrowParabola(float t) { 
    return sqr(t - 0.5) * 2;  // <= Modify this line
}

float widenAndMoveParabola(float t) { 
    return  2 * sqr(t - 0.75);  // <= Modify this line
}

float moveCubicLeft(float t) { 
    return  13 * cub(t + 0.25) - 10 * sqr(t + 0.25) + 1;  // <= Modify this line
}

float moveCubicDown(float t) { 
    return  (13*cub(t) -10 * sqr(t) + 1) -0.25 ;  // <= Modify this line
}
...
float easeOut(float t) { 
    return -sqr(t-1) +1;  // <= Modify this line
}

float easeInThruCentre(float t) { 
    return sqr(t) *2  ;  // <= Modify this line
}

float easeOutThruCentre(float t) { 
    return  ( -sqr(t - 1) * 2 ) +1 ;  // <= Modify this line
}
